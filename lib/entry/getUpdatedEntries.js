...
const getFilesLastModifiedTimes = require('../fs/getFilesLastModifiedTimes')
 ...
 */
const reduceEntry = (task, entry) => task.and(Task.waitAll([
    getFilesLastModifiedTimes([entry.srcIndex, entry.srcContent, entry.srcExcerpt, entry.distIndex]),
 ...
 */
const getUpdatedEntries = entries => entries.reduce(reduceEntry, Task.of([]))
